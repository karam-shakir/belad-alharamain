  ...
  return (
    <>
      ...
      <a
        ...
        aria-label="WhatsApp"
        className="wa-pulse fixed bottom-6 end-6 z-50 w-14 h-14 rounded-full
      ...
      >
        ...
        {/* Tooltip */}
        <span className="absolute end-full me-3 whitespace-nowrap bg-black/80 text-white
      ...
      <button
        ...
        className={`fixed bottom-24 end-6 z-50 w-11 h-11 rounded-xl
